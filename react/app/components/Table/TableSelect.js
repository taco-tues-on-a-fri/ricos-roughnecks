...
//| 12-28-19: Attempting to fix the error:
//| 12-28-19:   Warning <tr> cannot appear as a child of <table>. Add a <tbody>, <thead> or <tfoot> to your code to match the DOM tree generated by the browser.
//| 12-28-19: Implemented: <tbody> wrapper before the mapping of { query }
//| 12-28-19: Result: Working No initial load errors but errors from subsequent button clicks still generate the errors below
//|------------------------------------------------------------------------
//| 12-28-19: Errors:
